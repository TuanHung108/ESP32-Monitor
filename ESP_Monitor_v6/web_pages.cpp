// Implementation: web_pages.h
// HTML/CSS/JS dashboard (copied unchanged from v5)
// This file is auto-generated from v5's web_pages.h
// No changes made to preserve exact UI/UX compatibility
    ...
    <script>
        ...
        function updateDashboardRealtime() {
            ...
            .then(data => {
                ...
                document.getElementById('clock-str').innerText = data.sys_time;
