...
// Chu kỳ lấy mẫu chính (5 giây)
#define SAMPLE_INTERVAL_MS  5000

// Thời gian chờ reset cảm biến (30 giây)
#define REINIT_COOLDOWN_MS  30000

// Chu kỳ đồng bộ NTP (6 giờ)
#define NTP_SYNC_INTERVAL   21600000UL

// Thời gian chờ sau boot trước lần đồng bộ NTP đầu tiên (5 giây)
#define NTP_WARMUP_DELAY    5000

// Chu kỳ cập nhật OLED (mỗi lần sample đều refresh)
#define OLED_PAGE_CYCLE     3  // Cycle through 3 pages

// Chu kỳ ghi CSV (giống chu kỳ sample)
